...
namespace NGettext.Avalonia.Tests
{
    public class GettextExtensionTest
    {
        ...
        readonly TestClass _valueTarget = new TestClass();

        public class TestClass : Control
        {
            public static readonly AvaloniaProperty TextProperty = AvaloniaProperty.Register<TestClass,string>("Text");
            ...
            ValueTarget_Is_Not_Updated_On_Localizer_CultureTracker_CultureChanged_When_ValueTarget_Has_Been_Unloaded()
        {
            ...
            target.ProvideValue(_serviceProvider);
            // @@@ _valueTarget.RaiseEvent(new RoutedEventArgs(WindowUnloaded));
