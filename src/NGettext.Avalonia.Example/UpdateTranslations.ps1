...
$env:Path += ";..\..\tools\Gettext.Tools.0.19.8.1\tools\bin\"

# Extract msgids from xaml files in project into pot file.  If you installed NGettext.Avalonia via nuget you can source like so:
#   . XGetText-Xaml.ps1
# instead of the following
. ../../XGetText.Xaml/XGetText-Xaml.ps1
XGetText-Xaml -o obj/xamlmessages.pot -k Gettext,GettextFormatConverter @(Get-ChildItem -Recurse -File -Filter *.axaml | Where { $_.FullName -NotLike '*\obj\*' } | ForEach-Object { $_.FullName })
